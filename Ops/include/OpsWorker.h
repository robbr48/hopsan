...
enum AlgorithmT {Undefined, NelderMead, ComplexRF, ComplexRFP,  ParticleSwarm, DifferentialEvolution, Genetic, SimulatedAnnealing, ParameterSweep, ControlledRandomSearch, ComplexBurmen};
